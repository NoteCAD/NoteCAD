...
public class Style {
	...
	public void Write(Writer xml) {
		...
		xml.WriteAttribute("width", stroke.width);
		//xml.WriteAttributeString("stipple", stroke.stippleWidth.ToStr());
		xml.WriteAttribute("depth", stroke.depthTest);
		xml.WriteAttribute("inPixels", stroke.inPixels);
		xml.WriteAttribute("dashesInPixels", stroke.dashesInPixels);
		xml.WriteAttribute("queue", stroke.queue);
		xml.WriteAttribute("r", stroke.color.r);
		xml.WriteAttribute("g", stroke.color.g);
